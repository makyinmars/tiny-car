...
fn addAssets(b: *std.Build, exe: *std.Build.Step.Compile) void {
    const assets = [_]struct { []const u8, []const u8 }{
        ...
        .{ "resources/sound/open-wheel.wav", "open-wheel-engine" },
        .{ "resources/sound/pedestrian-alert.wav", "pedestrian-alert" },
        .{ "resources/sound/fast-alert.wav", "fast-alert" },
        .{ "resources/sound/whoops.wav", "whoops" },
        .{ "resources/textures/cars.png", "cars" },
        .{ "resources/textures/open-wheel.png", "open-wheel" },
        .{ "resources/textures/pedestrians.png", "pedestrians" },
