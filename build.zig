...
//         const exe_lib = emcc.compileForEmscripten(b, "tiny_car", "src/main.zig", target, optimize);
//
...
//         link_step.addArg("resources/sound@sound");
//         link_step.addArg("--embed-file");
//         link_step.addArg("resources/textures@textures");
//
//         // Add Emscripten-specific flags
//         link_step.addArg("-s");
//         link_step.addArg("USE_GLFW=3");
//         link_step.addArg("-s");
//         link_step.addArg("ASYNCIFY");
//         link_step.addArg("-s");
//         link_step.addArg("USE_OFFSET_CONVERTER=1");
//
//         b.getInstallStep().dependOn(&link_step.step);
//
//         const run_step = try emcc.emscriptenRunStep(b);
//         run_step.step.dependOn(&link_step.step);
//         const run_option = b.step("run", "Run tiny_car");
//         run_option.dependOn(&run_step.step);
//         return;
//     }
//
//     const exe = b.addExecutable(.{ .name = "tiny_car", .root_source_file = b.path("src/main.zig"), .optimize = optimize, .target = target });
//
...
//     const run_step = b.step("run", "Run tiny_car");
